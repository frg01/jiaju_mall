...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        <h3 class="cart-page-title">订单-${requestScope.orderItems[0].orderId}</h3>
        <div class="row">
...
<%--                            订单详情展示--%>
                            ...
                            <tr>
                                ...
                                <input type="hidden" value="${count = orderItem.count + count}"/>
                                <input type="hidden" value="${price = orderItem.totalPrice + price}"/>
                            </tr>
                            </c:forEach>
<%--                            <tr>--%>
