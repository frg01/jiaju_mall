            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <!-- Single Wedge End -->
                        <%--1.通过分析 offcanvas-toggle  会在main.js 中处理 阻止超链接跳转‘
                            2.所以要去掉 ， 恢复超链接的本身机制
                        --%>
                        <a href="cartServlet?action=page"
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up"
                                ...
                                <div class="product">
                                    <div class="thumb">
                                        ...
                                        <button title="添加到购物车" id="${furn.id}" class="add-to-cart">Add
                                            To Cart
                                        </button>
                                    </div>
                                    <div class="content">
