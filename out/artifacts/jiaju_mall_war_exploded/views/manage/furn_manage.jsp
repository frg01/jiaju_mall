    ...
    <script type="text/javascript">
        $(function () {
            $("a.deleteCss").click(function () {
                ...
                return confirm("是否确定删除【" + furnName + "】？")
            })
            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <div class="header-bottom-set dropdown">
                            <a href="views/manage/furn_add.jsp?pageNum=${requestScope.page.pageNumber}">添加家居</a>
                        </div>
                    </div>
                </div>
                <!-- Header Action End -->
                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <span class="loginErrorMsg"
                                  style="float: right; font-weight: bold; font-size: 20pt; margin-left: 10px;">${mesg == null ? "" : mesg}</span>
                            <c:forEach items="${requestScope.page.items}" var="furn">
                                <tr>
                                    ...
                                    <td class="product-remove">
                                        <%--"manage/furnServlet?action=showFurn&id=${furn.id}&pageNo=${requestScope.page.pageNo}"--%>
                                        <a href="manage/furnServlet?action=queryFurnById&id=${furn.id}&pageNum=${requestScope.page.pageNumber}" id="editFurn"><i
                                                class="icon-pencil"></i></a>
                                        <a class="deleteCss"
                                           href="manage/furnServlet?action=deleteFurn&id=${furn.id}&pageNum=${requestScope.page.pageNumber}"><i
        ...
        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
            <ul>
                <c:if test="${requestScope.page.pageNumber > 1}">
                    <li><a href="${requestScope.page.url}1">首页</a></li>
                <li>
                    <a href="${requestScope.page.url}${requestScope.page.pageNumber - 1}">上一页</a>
                </li>
                </c:if>
                    <c:choose>
                        ...
                        <c:when test="${requestScope.page.pageTotalCount > 5}">
                            <c:choose>
                                ...
                                <c:when test="${requestScope.page.pageNumber > requestScope.page.pageTotalCount - 3}">
                ...
                <c:forEach begin="${begin}" end="${end}" var="i" >
                    ...
                    <c:if test="${i == requestScope.page.pageNumber}">
                        <li><a class="active" href="manage/furnServlet?action=page&pageNum=${i}" >${i}</a></li>
                    </c:if>
                    <c:if test="${i != requestScope.page.pageNumber}">
<%--                        <c:if test="${i < requestScope.page.pageNumber +4}">--%>
                        <li><a href="manage/furnServlet?action=page&pageNum=${i}" >${i}</a></li>
<%--                        </c:if>--%>
                    </c:if>
                </c:forEach>
                <c:if test="${requestScope.page.pageNumber < requestScope.page.pageTotalCount}">
                    <li><a href="${requestScope.page.url}${requestScope.page.pageNumber + 1}">下一页</a></li>
                    <li><a href="${requestScope.page.url}${requestScope.page.pageTotalCount}">末页</a></li>
                </c:if>
                <li><a>共${requestScope.page.pageTotalCount}页</a></li>
                <li><a>共${requestScope.page.totalRow}条</a></li>
            </ul>
        </div>
