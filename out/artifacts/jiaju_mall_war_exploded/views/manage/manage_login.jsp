                        ...
                        <div id="lg1" class="tab-pane active">
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <form action="adminServet?action=managerLogin" method="post">
                                        <input type="hidden" name="action" value="managerLogin">
                                        <input type="text" name="username" value="${requestScope.username == null ? "" : requestScope.username}" placeholder="Username"/>
