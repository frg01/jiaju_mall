...
<head>
    ...
    <script type="text/javascript">
        ...
        //     $("#addFurn").click(function (){
        //         //验证价格格式 正则表达式错误，请重新改正！！！！
        //         var $price = $("input[name=price]");
        //         var pricePattern = /^[1-9]+(.[0-9]+)?$/;
        //         if (!pricePattern.test($price)){
        //             $("span.errorMsg").text("价格格式错误！")
        //             return false;
        //         }
        //
        //         //验证销量格式
        //         var $sales = $("input[name=sales]");
        //         var salesPattern = /^[1-9][0-9]+$/
        //         if (!salesPattern.test($sales)){
        //             $("span.errorMsg").text("销量格式错误！")
        //             return false;
        //         }
        //
        //         //验证库存量格式
        //         var $stock = $("input[name=stock]");
        //         var stockPattern = /^[1-9][0-9]+$/
        //         if (!stockPattern.test($stock)){
        //             $("span.errorMsg").text("库存量格式错误！")
        //             return false;
        //         }
        //     })
        })
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <form action="manage/furnServlet" method="post">
                    ...
                    <input type="hidden" name="action" value="addFurn">
                        <%--增加一个隐藏域给action-pageNum--%>
                        <input type="hidden" name="pageNum" value="${param.pageNum}">
                    <div class="table-content table-responsive cart-table-content">
                        <span class="ErrorMsg"
                              style="float: right; font-weight: bold; font-size: 20pt; margin-left: 10px;">${requestScope.mesg == null ? "" : requestScope.mesg}</span>
                        <table>
                            <thead>
                            <tr>
                                <th>图片</th>
...
<!--                                    <a href="#"><i class="icon-close"></i></a>-->
                                    <input type="submit" id="addFurn" style="width: 90%;background-color: silver;border: silver;border-radius: 20%;" value="添加家居"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
