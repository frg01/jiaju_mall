    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <form enctype="multipart/form-data" action="manage/furnServlet?id=${requestScope.furn.id}&action=updateFurn&pageNum=${requestScope.pageNum}" method="post">
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tr>
                                ...
                                <%--隐藏域id和imgPath与action与pageNum--%>
                                <%--<input name="id" type="hidden" value="${requestScope.furn.id}">--%>
                                <%-- <input name="imgPath" type="hidden" value="${requestScope.furn.imgPath}"><input name="action" type="hidden" value="updateFurn">--%>
